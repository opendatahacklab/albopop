...
class AlboTorinoItemConverter implements AlboToRSSItemConverter {
	...
	function getRSSItem($alboTorinoItem) {
		...
		$sharer_url="http://www.opendatahacklab.org/albopop/torino/sharer.php?subpage=".urlencode($alboTorinoItem->subPageURI)."&year=".$alboTorinoItem->year."&number=".$alboTorinoItem->number;
