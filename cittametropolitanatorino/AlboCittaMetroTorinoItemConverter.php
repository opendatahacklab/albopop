...
class AlboCittaMetroTorinoItemConverter implements AlboToRSSItemConverter 
{
	...
	function getRSSItem($alboMetroTorinoItem) {
		...
		$sharer_url="http://www.opendatahacklab.org/albopop/cittametropolitanatorino/sharer.php?subpage=".urlencode($alboMetroTorinoItem->subPageURI)."&year=".$alboMetroTorinoItem->year."&number=".$alboMetroTorinoItem->number;
