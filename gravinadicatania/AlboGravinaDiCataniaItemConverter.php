<?php
/**
 * Convert AlboGravinaDiCataniaEntry instances to RSSItem ones 
 ...
 *
 */
class AlboGravinaDiCataniaItemConverter implements AlboToRSSItemConverter {
	...
	function getRSSItem($albojCityGovItem) {
		...
		$rssItem->link=$albojCityGovItem->url;
		$rssItem->guid=$albojCityGovItem->url;
		return $rssItem;
	}
}
?>